...
def start_pipeline():
    run_details = os.system('airflow_test_env/bin/airflow dags trigger CNN-Training-Pipeline')
    # Return the issue & confidence
...
def start_server():
    os.system('airflow_test_env/bin/airflow webserver -D')
    os.system('airflow_test_env/bin/airflow scheduler')
    # Return the issue & confidence
